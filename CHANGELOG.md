...
- [`97bd771`](https://github.com/mkaradeniz/is-not-null-or-undefined/commit/97bd77162c10331cd827b8fe7d7ca0a5ee731480) - Release v2 with a broader set of TypeScript predicates, type guards, and modern package infrastructure.
  ...
  `hasRenderableNode` treats `null`, `undefined`, booleans, empty strings, empty iterables, and iterables without renderable items as not renderable.
